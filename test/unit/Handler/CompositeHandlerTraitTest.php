...
use Inpsyde\MultilingualPress2to3\Handler\CompositeHandlerTrait as TestSubject;
 ...
 */
class CompositeHandlerTraitTest extends TestCase
{
    ...
    {
        $subject = $this->getMockBuilder(TestSubject::class, $methods, null)
            ->getMockForTrait();
    ...
    {
        {
            $subject = $this->_createSubject(null);
